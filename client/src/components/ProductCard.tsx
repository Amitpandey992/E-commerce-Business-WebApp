            ...
            <div className="border rounded-lg p-4 flex flex-col justify-between h-full shadow-lg hover:shadow-2xl transition-shadow duration-300 bg-white transform hover:-translate-y-2">
                ...
                {cartItem ? (
                    ...
                    <button
                        ...
                        className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-300 mb-3"
                    >
                        Add to Cart
                    </button>
                )}
                ...
                {cartItem ? (
                    ...
                    <button
                        ...
                        className="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors duration-300 text-center"
                    >
                        View Details
                    </button>
                )}
