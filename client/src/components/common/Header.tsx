        ...
        <header className="bg-blue-900 text-white p-6 px-10">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center space-x-6">
                    <Link
                        to="/"
                        className="flex flex-col items-center gap-1 hover:text-yellow-300 transition duration-300"
                    >
                        <FaHome />
                ...
                <div className="md:hidden flex items-center">
                    <button
                        ...
                        className="text-xl text-white focus:outline-none z-50"
                    >
            ...
            {/* Mobile Menu */}
            <div
                className={`md:hidden fixed top-0 left-0 w-full h-full bg-blue-900 z-40 transition-transform transform ${
                    isMobileMenuOpen
