...
import { createRazorpayOrder, sendOtpForCod, verifyRazorpayPayment } from '../controllers/payment.controller';
...
router.post('/order/cod/verify-otp', authenticateUser, sendOtpForCod);
